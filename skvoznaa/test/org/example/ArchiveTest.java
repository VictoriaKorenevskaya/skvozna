...
class ArchiveTest {
    ...
    void readTxtFileFromArchive() {
        String result = Archive.readStringFromFileInArchive("test_txt.zip", "test.txt");
    ...
    void readJsonFileFromArchive() {
        String result = Archive.readStringFromFileInArchive("test_json.zip", "test.json");
    ...
    void readXmlFileFromArchive() {
        String result = Archive.readStringFromFileInArchive("test_xml.zip", "test.xml");
